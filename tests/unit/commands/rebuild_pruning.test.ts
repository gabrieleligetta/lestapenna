...
describe('Rebuild Command - Pruning', () => {
    ...
    beforeEach(() => {
        ...
        // FKs are enabled: inserts with campaign_id=1 require the parent campaign
        mockDb.prepare("INSERT OR IGNORE INTO campaigns (id, guild_id, is_active) VALUES (1, 'test_guild', 1)").run();
    });
