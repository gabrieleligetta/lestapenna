...
describe('CampaignJournalCarousel', () => {
    ...
    it('aligns every page to the same leading shelf edge', async () => {
        const user = userEvent.setup();
        renderCarousel();
        ...
        track.style.paddingInlineStart = '24px';
    ...
    it('uses the leading shelf edge to track the current journal while scrolling', () => {
        renderCarousel();
        ...
        vi.spyOn(journals[1], 'getBoundingClientRect').mockReturnValue(new DOMRect(126, 0, 280, 400));
        vi.spyOn(journals[2], 'getBoundingClientRect').mockReturnValue(new DOMRect(422, 0, 280, 400));
