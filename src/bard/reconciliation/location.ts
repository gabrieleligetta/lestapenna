...
/**
 * Normalizes location names by removing duplicated prefixes.
 */
...
/**
 * Computes the similarity between two locations (combining macro and micro).
 */
function locationSimilarity(
    ...
    // NEW: if the micro location is significantly unique/identical (e.g. "Paludi dei Morti"), treat it as a high match
...
/**
 * ENHANCED version: asks the AI whether two locations are the same place using RAG + phonetics
 */
...
/**
 * Asks the AI whether two locations refer to the same place.
 */
...
/**
 * Finds the canonical name when a similar location exists in the atlas.
 */
...
/**
 * Pre-dedupes a batch of location updates BEFORE saving them.
 */
